...
class BarChartApi extends StatefulWidget {
  ...
  @override
  _BarChartApiState createState() => _BarChartApiState();
}
            ...
            Container(
              ...
              child: const Text.rich(
                TextSpan(children: [
                  TextSpan(
                    text:
                        'Barchart data view of the market sales against selected model and profits against selected model over the last 4 years.',
                    style: TextStyle(
                      fontSize: 18,
