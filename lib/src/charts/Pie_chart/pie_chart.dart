...
import '../Bar_chart/barchart_model.dart';
import '../sales_model.dart';
import 'dart:math' as math;

class PieChartApi extends StatefulWidget {
  const PieChartApi({Key? key}) : super(key: key);

  @override
  _PieChartApiState createState() => _PieChartApiState();
}

class _PieChartApiState extends State<PieChartApi> {
  ...
  List<charts.Series<BarChartModel, String>> _createSampleData() {
    ...
    for (SalesModel salesModel in sales) {
      String xValue = _getPropertyValue(salesModel, selectedYProperty);
      double ySales =
            ...
            Container(
              ...
              child: const Text.rich(
                TextSpan(children: [
                  TextSpan(
                    text:
                        'Piechart data view of the market sales against selected model and profits against selected model over the last 4 years.',
                    style: TextStyle(
                      fontSize: 18,
